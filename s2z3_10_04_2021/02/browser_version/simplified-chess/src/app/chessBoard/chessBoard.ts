...
class Chessboard {
    ...
    public setEmptyBoard(): void {
        ...
        // draws chessboard from black perspective, a1 is at left-top
        let curColor: Color = Color.Black; // a8 is black
        for (let r = 0; r < 8; r++) {
     ...
     */
    private isKingCollidingWithOtherKing(
        row: number,
        col: number,
        king: King
    ): boolean {
